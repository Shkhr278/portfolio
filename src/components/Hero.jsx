...
export default function Hero() {
  ...
  // Removed blurValue as it causes heavy repaints on scroll
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="text-fluid-p uppercase tracking-[0.3em] text-[var(--color-neon-blue)] block mb-6 font-normal">
        ...
        >
          <a 
            ...
            className="group relative inline-flex items-center justify-center px-10 py-4 rounded-full font-normal overflow-hidden transition-transform hover:scale-105 active:scale-95 glass-panel text-white"
          >
            <span className="relative z-10 font-extrabold tracking-wide text-lg">Explore Work</span>
