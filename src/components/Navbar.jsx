...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-6 w-full z-50 flex justify-center px-4 pointer-events-none">
      ...
      >
        <a href="#" className="text-xl font-bold tracking-tighter text-white hover:text-[var(--color-neon-blue)] transition-colors">
        ...
        <div className="flex items-center gap-4 md:gap-8">
          <ul className={`hidden md:flex items-center gap-8 ${isScrolled ? 'text-sm' : 'text-base'} font-medium transition-all`}>
            <li><a href="#projects" className="text-gray-300 hover:text-white transition-colors">Works</a></li>
